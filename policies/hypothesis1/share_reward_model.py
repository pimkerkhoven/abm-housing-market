...
Government.set_new_tax_rate = set_new_tax_rate_sharing

hooks = Hooks(
    post_init=[make_rental_market_share_market],
...
if __name__ == '__main__':
    for reward in rewards:
        model = Runner(run_settings, parameters, Rules(share_bonus=reward),
