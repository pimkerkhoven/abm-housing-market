...
def deserve_bonus(household):
    ...
    for record in household.history:
        # TODO: buy to constant
        # If this is not first time buying house, household does NOT deserve bonus
        if record[0] == "Buy":
            return False
...
rules = Rules(buy_bonus={"value": 100_000, "deserve?": deserve_bonus})
